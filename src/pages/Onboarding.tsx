...
const Onboarding = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const submitData = async () => {
      try {
        const response = await fetch('https://formcarry.com/s/5zQ6X2hYLyA', {
          method: 'POST',
          headers: {
          ...
          body: JSON.stringify({
            ...
            investmentGoals: formData.investmentGoals.join(', '),
            ...
            source: 'InvestPro Onboarding Form'
          })
        });
        ...
        if (response.ok) {
          ...
          setFormData({
            ...
            annualIncome: '', netWorth: '', liquidNetWorth: '', initialInvestment: '',
            investmentExperience: '', riskTolerance: '', timeHorizon: '', investmentGoals: [],
            accountType: '', politicallyExposed: '', investmentKnowledge: ''
          });
          setCurrentStep(1);
        } else {
